...
export default function Blog() {
  ...
  useSEO({
    title: "Blog — Tips & Inspirasi Perjalanan",
    description: "Panduan praktis menyusun trip keluarga, korporat, dan wisata rombongan lintas Jawa–Bali dari tim RahazaTrans.",
  ...
  return (
    <div>
      <PageHero eyebrow="Blog" title="Tips & inspirasi perjalanan"
        subtitle="Panduan praktis menyusun trip keluarga, korporat, dan wisata rombongan lintas Jawa–Bali."
        image="https://images.unsplash.com/photo-1488646953014-85cb44e25828?q=80&w=2000&auto=format&fit=crop"
        breadcrumb={[{ label: "Beranda", to: "/" }, { label: "Blog" }]} />
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 md:py-20">
          {loading ? (
            ...
            <>
              {cat === ALL && featured ? <FeaturedStory a={featured} /> : null}
              ...
              <div className="mt-8 grid gap-8 lg:mt-10 lg:grid-cols-[200px_1fr]">
                <aside className="hidden lg:block">
                  <p className="mb-3 text-[11px] font-semibold uppercase tracking-[0.18em] text-muted-foreground">Kategori</p>
