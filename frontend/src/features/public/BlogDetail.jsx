  ...
  if (error || !a) {
    return (
      <div className="flex min-h-[70vh] flex-col items-center justify-center gap-3 pt-24" data-testid="blog-detail-error">
        ...
        <Link to="/blog" className="rounded-full bg-primary px-4 py-2 text-[13px] font-semibold text-primary-foreground">Kembali ke Blog</Link>
      </div>
    );
  }
  ...
  return (
    <div>
      ...
      <article className="mx-auto w-full max-w-[68ch] px-5 py-12" data-testid="blog-detail-body">
        ...
        <div className="mt-6 space-y-5 text-[16px] leading-[1.85] text-foreground/80">
          {paragraphs.map((p, i) => (
        ...
        <Reveal className="mt-10">
          <CtaBand
            ...
            subtitle="Dapatkan estimasi biaya transparan dan penawaran resmi dari tim RahazaTrans."
            primary={{ to: "/quotation", label: "Minta Penawaran", testId: "blog-cta-quotation" }}
            secondary={{ to: "/fleet", label: "Lihat Armada", icon: Bus, testId: "blog-cta-fleet" }}
          />
        </Reveal>
      </article>
